...
export const api = {
  ...
  workspace: {
    ...
    getInviteCode: () => request('/workspace/invite-code'),
    regenerateCode: () => request('/workspace/invite-code/regenerate', { method: 'POST' }),
  },
  projects: {
    ...
    addMember: (id, userId) => request(`/projects/${id}/members`, { method: 'POST', body: { userId } }),
